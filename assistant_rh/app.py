"""Application Streamlit : Assistant RH (RAG + tools + middleware + memoire).

Lancer depuis la racine du projet :
    streamlit run assistant_rh/app.py
"""
import sys
...
from assistant_rh import rag, tools
from assistant_rh.agent import build_agent
from assistant_rh.models import ADVANCED_MODEL, BASIC_MODEL
...
def main():
    ...
    st.subheader("Assistant RH", divider="blue")
    st.caption("RAG sur le reglement interieur + tools (BDD employes, calculs conges/anciennete) "
               "+ memoire + middleware de role.")
    ...
    with st.sidebar:
        ...
        if st.session_state.retriever is not None:
            ...
            st.error("Aucun reglement. Depose un PDF dans assistant_rh/documents/ "
